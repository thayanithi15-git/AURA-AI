...
import { Settings, Sparkles, ChevronDown, Globe, Check, Sun, Moon, Menu, X } from 'lucide-react'
    ...
    <main className="min-h-screen bg-[#f8fafc] text-[#0f172a] dark:bg-[#0a0a0a] dark:text-[#f8fafc] flex flex-col relative lg:overflow-hidden overflow-x-hidden overflow-y-auto font-sans">
      ...
      <header className="w-full px-4 py-3 md:px-6 md:py-4 border-b border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-950/80 backdrop-blur-md flex items-center justify-between z-20 shadow-sm">
        <div className="flex items-center gap-2 md:gap-3">
          <img src="/logo.png" alt="ARTHA AI Logo" className="w-10 h-10 md:w-12 md:h-12 rounded-lg object-contain shadow-sm border border-slate-100 dark:border-slate-800" />
          <div>
        ...
        <div className="hidden md:flex items-center gap-2 md:gap-3">
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            >
              ...
              <ChevronDown className="h-4 w-4 opacity-50 transition-transform duration-200" style={{ transform: langDropdownOpen ? 'rotate(180deg)' : 'none' }} />
            </button>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden w-full bg-white/95 dark:bg-slate-950/95 border-b border-slate-200 dark:border-slate-800 backdrop-blur-md z-30 shadow-lg px-4 py-4 space-y-4 animate-in slide-in-from-top-2 duration-200">
          ...
          <div className="flex items-center justify-between py-2 border-t border-slate-100 dark:border-slate-900">
            <span className="text-sm font-semibold text-slate-600 dark:text-slate-350">Theme Mode</span>
            <button
              onClick={toggleDarkMode}
              className="relative inline-flex h-9 w-[68px] items-center rounded-full bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:border-slate-300 dark:hover:border-slate-700 transition-all duration-300 focus:outline-none shadow-sm cursor-pointer"
            >
